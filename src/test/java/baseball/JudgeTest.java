...
public class JudgeTest {
    ...
    @Test
    void judgeNothing() {
        assertThat(judge(new Numbers("123"), new Numbers("456"))).isEqualTo(new Judgement(0, 0));
    }
    ...
    void judgeOneStrike(String rightNumbers, String inputNumbers) {
        assertThat(judge(new Numbers(rightNumbers), new Numbers(inputNumbers))).isEqualTo(new Judgement(1, 0));
    }
    ...
    void judgeTwoStrike(String rightNumbers, String inputNumbers) {
        assertThat(judge(new Numbers(rightNumbers), new Numbers(inputNumbers))).isEqualTo(new Judgement(2, 0));
    }
    ...
    void judgeOneBall(String rightNumbers, String inputNumbers) {
        assertThat(judge(new Numbers(rightNumbers), new Numbers(inputNumbers))).isEqualTo(new Judgement(0, 1));
    }
}
